...
Location: `src/losses/adversarial_loss.py`
...
channel output map of discriminator scores. Spectral Normalization was also wrapped around the convolutional layers in order to stablize training.
