...
from hair_gan.models.CtrlHair.external_code.face_parsing.model import BiSeNet
from hair_gan.models.CtrlHair.global_value_utils import PARSING_LABEL_LIST
