...
from hair_gan.models.CtrlHair.external_code.face_parsing.my_parsing_util import FaceParsing_tensor
from hair_gan.models.stylegan2.model import Generator
from hair_gan.utils.drive import download_weight
...
class Net(nn.Module):
    ...
    def build_PCA_model(self, PCA_path):
        ...
        from hair_gan.utils.PCA_utils import IPCAEstimator
