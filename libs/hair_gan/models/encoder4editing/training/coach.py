...
from hair_gan.utils import common, train_utils
from criteria import id_loss, moco_loss
from configs import data_configs
from hair_gan.datasets.images_dataset import ImagesDataset
from criteria.lpips.lpips import LPIPS
from hair_gan.models.psp import pSp
from hair_gan.models.latent_codes_pool import LatentCodesPool
from hair_gan.models.discriminator import LatentCodesDiscriminator
from hair_gan.models.encoders.psp_encoders import ProgressiveStage
        ...
        while self.global_step < self.opts.max_steps:
            for batch_idx, batch in enumerate(self.train_dataloader):
                ...
                if self.global_step % self.opts.image_interval == 0 or (
                    ...
                    self.parse_and_log_images(id_logs, x, y, y_hat, title='images/scripts/faces')
                if self.global_step % self.opts.board_interval == 0:
                    self.print_metrics(loss_dict, prefix='scripts')
                    self.log_metrics(loss_dict, prefix='scripts')
